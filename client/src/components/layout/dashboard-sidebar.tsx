...
export function DashboardSidebar({ userRole, isOpen, onClose }: DashboardSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Fixed Sidebar - Z-index below header */}
      <div
        className={`fixed top-0 left-0 h-full w-72 bg-white/95 backdrop-blur-xl border-r border-gray-100/50 transform transition-all duration-500 ease-out z-40 shadow-2xl shadow-black/5 ${
      ...
      >
        ...
        {/* Header with top padding to avoid header overlap */}
        <div className="relative pt-20 md:pt-6 p-6 border-b border-gray-100/50">
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-2 h-[calc(100vh-180px)] md:h-[calc(100vh-140px)]">
        ...
        {/* Enhanced Footer */}
        <div className="p-4 border-t border-gray-100/50 bg-gradient-to-r from-gray-50/30 to-transparent">
