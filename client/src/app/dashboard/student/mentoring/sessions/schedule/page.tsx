      ...
      <div className="bg-white rounded-xl shadow-sm border p-8">
        <div className="flex items-start justify-between">
          ...
          <div>
            ...
            <div>
              <h1 className="text-4xl font-bold text-gray-900 mb-3">Schedule Mentoring Session</h1>
              <p className="text-xl text-gray-600">Book a session with your mentor</p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="shadow-sm">
            <CardHeader>
              <CardTitle className="text-xl">Select Mentor</CardTitle>
            </CardHeader>
              ...
              {selectedMentorData && (
                <div className="p-6 bg-blue-50 rounded-lg border">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">{selectedMentorData.name}</h3>
                      <p className="text-gray-600">{selectedMentorData.designation}</p>
                      <div className="flex items-center space-x-2 mt-2">
                        <Star className="h-4 w-4 text-yellow-500 fill-current" />
                        <span className="text-sm font-medium">{selectedMentorData.rating}</span>
                      </div>
                    </div>
                  </div>
                  <div className="mt-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">Individual Session</h3>
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">Group Session</h3>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {availableSlotsForDate.slots.map((slot) => (
                      <button
                        key={slot}
                        className={`p-4 text-base border rounded-lg transition-colors ${
                          selectedTime === slot
          ...
          <Card className="shadow-sm">
            ...
            <CardContent className="space-y-6">
              <div>
                <Label className="text-base font-medium mb-3 block">Topic/Subject</Label>
              ...
              <div>
                <Label className="text-base font-medium mb-3 block">Description (Optional)</Label>
                <Textarea
            ...
            <CardContent className="space-y-5">
              {selectedMentorData && (
                <div className="p-4 bg-gray-50 rounded-lg">
                  <p className="text-sm font-medium text-gray-700 mb-1">Mentor</p>
              ...
              {sessionType && (
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center space-x-2">
                    {sessionType === 'individual' ? <User className="h-5 w-5" /> : <Users className="h-5 w-5" />}
